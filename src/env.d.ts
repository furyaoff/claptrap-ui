...
interface ImportMetaEnv {
	...
	readonly VITE_FANFURY_MAILCHIMP_API: string
	readonly VITE_FANFURY_CONFIG_URL: string
	readonly VITE_FANFURY_FAUCET_URL: string
	readonly VITE_FANFURY_TWITTER_API: string
	readonly VITE_CLAPTRAP_GRAPHQL_API: string
