...
import { Merkledrop } from '../../../fanfury/merkledrop/v1beta1/merkledrop';
import { Params } from '../../../fanfury/merkledrop/v1beta1/params';
...
export class QueryClientImpl implements Query {
    ...
    Merkledrop(request: QueryMerkledropRequest): Promise<QueryMerkledropResponse> {
        ...
        const promise = this.rpc.request('fanfury.merkledrop.v1beta1.Query', 'Merkledrop', data);
    ...
    IndexClaimed(request: QueryIndexClaimedRequest): Promise<QueryIndexClaimedResponse> {
        ...
        const promise = this.rpc.request('fanfury.merkledrop.v1beta1.Query', 'IndexClaimed', data);
        return promise.then((data) => QueryIndexClaimedResponse.decode(new _m0.Reader(data)));
    }

    Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
        const data = QueryParamsRequest.encode(request).finish();
        const promise = this.rpc.request('fanfury.merkledrop.v1beta1.Query', 'Params', data);
