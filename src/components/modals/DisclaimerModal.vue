...
No part of the content and services that we provide on Claptrap constitutes financial advice, legal advice or any other form of advice meant for your specific reliance for any purpose, nor any dealing in (or promotion of) securities for which a licence is required from any competent Authorities. 

Any use or reliance on Claptrap content and services is solely at your own risk and discretion. 
...
Moreover, we use Google Analytics to carry out statistical analysis of page use and page interactions to evaluate and improve Claptrap. This is known as 'digital analytics'. 
For further information, you can send an email to legal@fanfury.io`
</script>

<template>
	<Modal v-model="model" no-esc-dismiss no-backdrop-dismiss no-route-dismiss>
		<div class="pt-10 full-height column no-wrap">
			<p class="fs-24 q-mb-40">Before you enter Claptrap DEx</p>
